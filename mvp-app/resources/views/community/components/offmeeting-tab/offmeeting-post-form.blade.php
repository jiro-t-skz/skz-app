<div x-data="{ showForm:false }">
    ...
    <div x-show="showForm"
        ...
        <form method="POST" action="{{ route('community.offmeeting.posts.store')}}">
            @csrf
            <div class="mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                ...
                <div>
                    ...
                    <select
                        ...
                        <option value="{{ $pref }}" @selected(old('prefecture') === $pref)>
                            {{ $pref }}
                        </option>
                        @endforeach
                    </select>
                ...
                <div>
                    <label class="block text-sm font-semibold text-sakura-purple mb-2">定員</label>
                        <select
                            name="capacity"
                            class="w-full px-4 py-3
                            ...
                            <option value="" class="text-sakura-purple">選択してください（任意）</option>
                                ...
                                @endfor
                            <option value="999" @selected(old('capacity') == 999)>制限なし</option>
                        </select>
                        @error('capacity')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
